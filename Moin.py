...
ADMIN_USERNAME = 'a4x_Crypto'  # Replace with your admin's Telegram username (without @)

# Customizable messages
OWNER_NAME = '@a4x_Crypto'  # Change this to the owner's name
WELCOME_MESSAGE = (
